...
//     }, [orders, searchTerm, currentPage, sortConfig, filterStatus]);
...
//             </div>
//             <table className='w-full bg-gray-100 rounded-lg shadow-md mt-4'>
...
//                         <tr key={order.id} className='border-b border-secondary-light hover:bg-gray-100'>
...
//                                 <Link to={`/orders/${order.id}`} className='text-sm px-2 mx-1 rounded text-white bg-secondary'>View</Link>
//                                 <Link to={`/orders/edit/${order.id}`} className='text-sm px-2 mx-1 rounded text-white bg-secondary'>Edit</Link>
//                             </td>
//                         </tr>
//                     ))}
//                 </tbody>
        ...
        <div className='w-full p-4 bg-white rounded-lg shadow-lg'>
            ...
            <div className='flex justify-between'>
                ...
                <div className='w-3/12 space-y-5'>
                    <div onClick={toggleOverdueOrders} className={`border-2 rounded-lg shadow-lg p-4 bg-gray-100 cursor-pointer`}>
                        <h1 className='text-center font-semibold text-primary-dark'>Total Overdue Orders</h1>
                        <p className='text-center text-2xl font-semibold py-2 text-secondary-dark'>{totalOverdueOrders}</p>
                    </div>
                    <div onClick={toggleIncompleteOrders} className='border-2 rounded-lg shadow-lg p-4 bg-gray-100 cursor-pointer'>
                        <h1 className='text-center font-semibold text-primary-dark'>Total Incomplete Orders</h1>
                        <p className='text-center text-2xl font-semibold py-2 text-secondary-dark'>{totalIncompleteOrders}</p>
                    </div>
                </div>
            </div>
            <div className='flex justify-center mt-4'>
                ...
                {[...Array(totalPages)].map((_, index) => (
                    <button
                        ...
                        className={`text-sm px-4 py-2 mx-1 rounded ${currentPage === index + 1 ? 'bg-primary-dark text-white' : 'bg-white text-primary-dark'}`}
                    >
                        {index + 1}
                    </button>
                ))}
