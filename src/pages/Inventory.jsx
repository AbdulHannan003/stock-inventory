        ...
        <div className='w-full p-4 bg-white rounded-lg shadow-lg'>
            ...
            <div className='flex justify-between'>
                        ...
                        {currentItems.map(item => (
                            <tr key={item.id} className={`border-b border-secondary-light hover:bg-gray-100 ${item.quantity <= item.lowStockThreshold ? 'bg-yellow-100' : ''}`}>
                                ...
                                <td className='text-center p-2'>
                                    <Link to={`/inventory/edit/${item.id}`} className='text-sm px-2 mx-1 rounded text-white bg-secondary '>Edit</Link>
                ...
                <div className='w-3/12 space-y-5'>
                    ...
                    <div onClick={toggleLowStock} className='border-2 rounded-lg shadow-lg p-4 bg-gray-100 cursor-pointer'>
                        <h1 className='text-center font-semibold text-primary-dark'>Low Stock Items</h1>
                        <p className='text-center text-2xl font-semibold py-2 text-secondary-dark'>{lowStockItems}</p>
                    </div>
                    <div className='border-2 rounded-lg shadow-lg p-4 bg-gray-100'>
